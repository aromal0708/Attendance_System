    ...
    try:
        ...
        if Confidence > 65:
            ...
            if df.loc[user_name, "Attendance"] == "Absent":
                ...
                df.to_excel(excel_path, sheet_name=sheet_name)
                # Print the user name and the time of attendance
                print(f"{user_name} is present at {current_time}")
            else:
                # Print that the user has already been marked as present
                print(f"{user_name} has already been marked as present")
