...
__all__ = [
    'SVSFIsFilename', 'SPVISEMES', 'SPAS_PAUSE', 'SITooLoud',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpMMSysAudio',
    'SPEI_RESERVED6', 'SpeechMicTraining', 'DISPID_SVVoice',
    'DISPID_SGRSTRule', 'STSF_FlagCreate', 'SPPS_Unknown',
    'SAFT48kHz16BitStereo', 'SP_VISEME_6', 'DISPID_SOTCDefault',
    'SVSFParseAutodetect', 'ISpeechXMLRecoResult',
    'SPDKL_CurrentUser', 'SPSEMANTICFORMAT',
    'DISPID_SpeechPhraseAlternates', 'ISpStreamFormatConverter',
    ...
    'SGPronounciation', 'SAFT24kHz8BitStereo', 'SAFT44kHz16BitStereo',
    'SpStreamFormatConverter', 'ISpeechRecognizer',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SRGCmdSetRuleState',
    'SPSHORTCUTPAIRLIST', 'SPINTERFERENCE_NONE',
    'DISPID_SpeechObjectToken', 'DISPID_SMSAMMHandle',
    'DISPID_SRGDictationLoad', 'DISPID_SVEViseme', 'SECLowConfidence',
    'SpeechVisemeFeature', 'DISPID_SRRTTickCount',
    'SPSERIALIZEDRESULT', 'DISPID_SCSBaseStream',
    'SAFT16kHz16BitStereo', 'SGSDisabled', 'DISPID_SPPParent',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SpeechAudioFormatType',
    'DISPID_SVEventInterests', 'DISPID_SpeechPhraseProperty',
    'SpPhoneticAlphabetConverter', 'ISpRecognizer3', 'SPFM_NUM_MODES',
    '__MIDL_IWinTypes_0009', 'DISPID_SVEWord', 'ISpeechAudioStatus',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFT12kHz8BitStereo',
    'SAFTCCITT_uLaw_11kHzMono', 'SPBO_NONE', 'ISpeechAudioBufferInfo',
    'DISPID_SpeechPhraseRules', 'DISPID_SAFSetWaveFormatEx',
    'SSFMOpenReadWrite', 'SAFT12kHz8BitMono', 'ISpeechVoice',
    'SPEI_RECO_STATE_CHANGE', 'SVP_5', 'SPEI_ADAPTATION',
    'DISPID_SPPName', 'SGDSActive', 'DISPID_SLWsItem',
    'DISPID_SVESentenceBoundary', 'DISPID_SPEs_NewEnum',
    'SDKLDefaultLocation', 'SpStream', 'SREBookmark', 'SVSFIsNotXML',
    'SPSUnknown', 'SRESoundEnd', 'DISPID_SOTCGetDataKey',
    'SPEI_RESERVED5', 'SVSFParseMask', 'SREAllEvents',
    'DISPID_SRRSpeakAudio', 'DISPID_SWFEFormatTag', 'SPSVerb',
    'SDA_No_Trailing_Space', 'SRSInactiveWithPurge',
    'DISPID_SRCRetainedAudioFormat', 'SDKLCurrentUser',
    'eLEXTYPE_PRIVATE20', 'DISPID_SBSRead', 'ISpeechPhraseInfo',
    'SRESoundStart', 'SAFT48kHz8BitMono', 'SpeechCategoryAudioOut',
    'DISPID_SGRSTsCount', 'DISPID_SLPsCount', 'DISPID_SGRSRule',
    'Speech_StreamPos_RealTime', 'SpeechCategoryRecognizers',
    'SAFTNonStandardFormat', 'SPRECOGNIZERSTATUS',
    'SPBOOKMARKOPTIONS', 'SPCT_SUB_COMMAND', 'SAFTADPCM_11kHzMono',
    'DISPID_SRGetPropertyString', 'DISPID_SAEventHandle',
    'SPAUDIOOPTIONS', 'SPEI_INTERFERENCE', 'SPWORDTYPE',
    'SREPropertyNumChange', 'SVEWordBoundary', 'DISPID_SGRAddState',
    'SPCT_DICTATION', 'SPAUDIOSTATE', 'DISPID_SRGDictationSetState',
    'eLEXTYPE_RESERVED9', 'SPLEXICONTYPE',
    'DISPID_SVSInputSentencePosition',
    'DISPID_SASCurrentDevicePosition', 'SpeechStreamFileMode',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SDKEnumValues',
    'ISequentialStream', 'SPEI_MIN_TTS', 'SPGRAMMARSTATE',
    'SRSActiveAlways', 'DISPID_SpeechLexiconWords', 'DISPID_SOTsItem',
    'SpeechVoiceCategoryTTSRate', 'DISPIDSPTSI_SelectionLength',
    'SPAS_STOP', 'ISpDataKey', 'DISPID_SPRNumberOfElements',
    'SPDATAKEYLOCATION', 'SPWORDPRONOUNCEABLE', 'STSF_AppData',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPSHT_EMAIL',
    'DISPID_SLGenerationId', 'SRAORetainAudio',
    'SAFT22kHz16BitStereo', 'SSFMCreate', 'SpeechWordPronounceable',
    'DISPID_SOTCategory', 'Speech_Max_Word_Length',
    'DISPID_SGRSTPropertyName', 'SpeechVoiceSpeakFlags',
    'DISPID_SVWaitUntilDone', 'DISPID_SRGetFormat', 'DISPID_SRCVoice',
    'SPPS_RESERVED3', 'ISpeechRecoResult2',
    'DISPID_SVSCurrentStreamNumber', 'SPEVENT', 'SPVPRI_NORMAL',
    'DISPID_SOTIsUISupported', 'DISPID_SBSFormat', 'DISPID_SFSOpen',
    'SPSHT_OTHER', 'DISPID_SFSClose', 'eLEXTYPE_PRIVATE10', 'SBONone',
    'SpAudioFormat', 'SPCT_COMMAND', 'DISPID_SpeechAudioStatus',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRSSupportedLanguages',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRIsShared',
    'SPEI_PHRASE_START', 'DISPID_SRCBookmark',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPPHRASEPROPERTY', 'ISpStream',
    'ISpeechWaveFormatEx', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SPIProperties', 'DISPID_SRCCmdMaxAlternates',
    'SpeechTokenShellFolder', 'SPBO_PAUSE',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPGS_ENABLED',
    'SpeechAudioProperties', 'DISPID_SPPEngineConfidence',
    'SpeechDataKeyLocation', 'SVP_15', 'DISPID_SGRsItem',
    'DISPID_SPIElements', 'SPINTERFERENCE_TOOLOUD', 'SVSFNLPMask',
    'DISPID_SRCERequestUI', 'SAFTText', 'ISpeechResourceLoader',
    'SpeechRecognizerState', 'SPINTERFERENCE_TOOQUIET',
    'SSFMCreateForWrite', 'DISPID_SPPValue', 'ISpeechBaseStream',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPAsItem',
    'eLEXTYPE_PRIVATE8', 'DISPID_SPEDisplayAttributes',
    'SP_VISEME_16', 'IStream', 'DISPID_SpeechPhraseAlternate',
    'SAFT8kHz8BitMono', 'SPEI_SOUND_START', 'DISPID_SPRuleName',
    ...
    'DISPIDSPTSI', 'SGRSTTTextBuffer', 'SPWORD', 'SPRULE',
    'DISPID_SLGetGenerationChange', 'IInternetSecurityManager',
    'DISPID_SRGSetTextSelection', 'DISPID_SpeechPhraseProperties',
    'ISpeechPhraseAlternates', 'DISPID_SRRTLength', 'SRSEIsSpeaking',
    'SP_VISEME_9', 'DISPID_SRRTimes', 'DISPID_SRCEventInterests',
    'DISPIDSPRG', '_ISpeechRecoContextEvents',
    'DISPID_SRRAudioFormat', 'eLEXTYPE_PRIVATE9', 'SPCATEGORYTYPE',
    'eLEXTYPE_PRIVATE12', 'SAFTADPCM_11kHzStereo',
    'DISPID_SPERequiredConfidence', 'DISPID_SRCESoundStart',
    'SpeechAudioFormatGUIDWave', 'LONG_PTR', 'IEnumSpObjectTokens',
    'DISPID_SGRId', 'DISPID_SPERetainedSizeBytes', 'SPLO_STATIC',
    'SLOStatic', 'DISPID_SVAudioOutputStream', 'DISPID_SRCRecognizer',
    'SGSEnabled', 'SpMMAudioEnum', 'SAFTADPCM_8kHzStereo',
    'DISPID_SLPSymbolic', 'IInternetSecurityMgrSite',
    'ISpXMLRecoResult', 'SP_VISEME_20', 'DISPID_SpeechRecoContext',
    'SPPHRASEREPLACEMENT', 'SLODynamic',
    'DISPID_SpeechObjectTokenCategory', 'SRAInterpreter', 'SVP_17',
    ...
    'SpObjectTokenCategory', 'SpResourceManager',
    'SSSPTRelativeToStart', 'SPSInterjection', 'DISPID_SpeechLexicon',
    'SVEStartInputStream', 'SAFTExtendedAudioFormat',
    'STSF_LocalAppData', 'SVSFPurgeBeforeSpeak', 'SpeechPartOfSpeech',
    'ISpeechLexiconWords', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SWFEChannels', 'eWORDTYPE_DELETED',
    'DISPID_SPAPhraseInfo', 'ISpPhoneticAlphabetConverter',
    'DISPID_SGRsCommit', 'DISPID_SABufferInfo', 'SVSFPersistXML',
    'DISPID_SRCEInterference', 'eLEXTYPE_RESERVED7',
    'SPSNotOverriden', 'DISPID_SLPsItem', 'ISpRecoResult',
    'SpeechPropertyLowConfidenceThreshold', 'SPCS_DISABLED',
    'WAVEFORMATEX', 'SRTEmulated', 'eLEXTYPE_MORPHOLOGY',
    'SAFTCCITT_uLaw_8kHzMono', 'SGDSActiveUserDelimited',
    'DISPID_SVSpeakStream', 'SPEI_MIN_SR', 'SREAudioLevel',
    'DISPID_SPRsCount', 'SPTEXTSELECTIONINFO', 'DISPID_SAFType',
    'STCAll', 'ISpeechGrammarRuleState', 'DISPID_SRDisplayUI',
    'DISPID_SLWWord', 'DISPID_SDKOpenKey', 'SPPS_RESERVED4', 'SDTAll',
    'ISpeechLexiconWord', 'ISpLexicon', 'SGRSTTWildcard',
    'DISPID_SPRuleId', 'DISPID_SRCEAudioLevel',
    'DISPID_SGRAttributes', 'SPCT_SLEEP', 'SPAR_Unknown',
    'SAFT48kHz8BitStereo', 'DISPID_SPISaveToMemory',
    'DISPID_SRCEPhraseStart', 'ISpeechPhraseProperties',
    'DISPID_SMSGetData', 'SVP_0', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SpeechWaveFormatEx', 'ISpeechCustomStream',
    'SAFTADPCM_8kHzMono', 'DISPID_SPEAudioTimeOffset',
    'SPPS_Modifier', 'DISPID_SRGIsPronounceable', 'SGRSTTEpsilon',
    'SAFT44kHz8BitMono', 'DISPID_SASNonBlockingIO', 'DISPID_SAFGuid',
    'DISPID_SVPriority', 'SVPNormal', 'SVESentenceBoundary',
    'SPWF_SRENGINE', 'DISPID_SPIReplacements', 'SWTAdded',
    'DISPID_SASFreeBufferSpace', 'SRCS_Enabled', 'SpeechInterference',
    'SDA_One_Trailing_Space', 'DISPID_SpeechFileStream',
    'eLEXTYPE_PRIVATE17', 'SpeechLoadOption', 'SVPOver',
    'eLEXTYPE_PRIVATE11', 'SpeechRecoContextState',
    'DISPID_SGRAddResource', 'DISPIDSPTSI_SelectionOffset',
    'SpeechWordType', 'ISpObjectTokenCategory', 'SECFDefault',
    'DISPID_SADefaultFormat', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SRTAutopause', 'SPEI_TTS_AUDIO_LEVEL', 'SPSLMA',
    'DISPID_SRCEPropertyNumberChange', 'SPEI_RECOGNITION',
    'DISPID_SpeechRecoResult2', 'DISPID_SPIGetText',
    'ISpeechPhraseRule', 'SVP_14', 'SPEI_RECO_OTHER_CONTEXT',
    'SWTDeleted', 'SAFTADPCM_22kHzMono', 'DISPID_SPRsItem',
    'SVEPrivate', 'eLEXTYPE_PRIVATE1', 'SREStreamEnd',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRGetPropertyNumber',
    'SPPS_SuppressWord', 'DISPID_SRCEPropertyStringChange',
    'ISpeechFileStream', 'SREPropertyStringChange',
    'DISPID_SRGCmdLoadFromMemory', 'ISpeechPhraseRules', 'SVEViseme',
    'DISPID_SDKCreateKey', 'SpeechAllElements', 'ISpSerializeState',
    ...
    'ISpeechObjectTokens', 'SAFT32kHz8BitStereo',
    'ISpeechRecoResultDispatch', 'DISPID_SVSpeak',
    'ISpeechPhraseAlternate', 'ISpeechPhraseReplacement', 'SPSNoun',
    'SDTDisplayText', 'SPEI_SR_BOOKMARK', 'DISPID_SPIAudioSizeBytes',
    'tagSPPROPERTYINFO', 'DISPID_SpeechMMSysAudio',
    'SpeechDiscardType', 'DISPID_SPPNumberOfElements',
    'SSTTDictation', 'DISPID_SpeechPhraseReplacements', 'SGRSTTWord',
    'DISPID_SRSClsidEngine', 'DISPID_SGRSTText', 'SPSHT_Unknown',
    'ISpeechTextSelectionInformation', 'ISpeechRecoResultTimes',
    'SFTSREngine', 'eLEXTYPE_PRIVATE6', 'SSFMOpenForRead',
    'DISPID_SpeechLexiconProns', 'ISpeechLexiconPronunciations',
    'ISpeechPhraseElement', 'DISPID_SLAddPronunciationByPhoneIds',
    'SRTStandard', 'SpSharedRecognizer', 'DISPID_SRRRecoContext',
    'SDTReplacement', 'SVSFNLPSpeakPunc', 'SECFIgnoreCase',
    'SPRST_ACTIVE', 'DISPID_SPRulesItem',
    'DISPID_SRCAudioInInterferenceStatus',
    'SWPUnknownWordUnpronounceable', 'DISPID_SVGetProfiles',
    'DISPID_SMSADeviceId',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFTCCITT_ALaw_11kHzStereo', 'SECHighConfidence', 'SVP_2',
    'SVF_None', 'DISPID_SRRGetXMLResult',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SVSLastBookmarkId', 'SpeechPropertyResourceUsage',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SVAudioOutput',
    'SP_VISEME_17', 'SpMemoryStream', 'DISPID_SVEStreamStart',
    'SVEAudioLevel', 'SpeechVoiceSkipTypeSentence', '_SPAUDIOSTATE',
    'SpTextSelectionInformation', 'SAFT12kHz16BitStereo',
    'SpeechTokenKeyFiles', 'DISPID_SVSInputWordLength',
    'SPPS_Noncontent', 'SPRS_ACTIVE_USER_DELIMITED',
    'SECFIgnoreKanaType', 'DISPID_SRStatus', 'UINT_PTR',
    'SVSFParseSapi', 'DISPID_SOTRemove', 'SREFalseRecognition',
    'SpWaveFormatEx', 'SpeechVoiceEvents', 'DISPID_SGRsCount',
    'eLEXTYPE_VENDORLEXICON', 'ISpeechObjectTokenCategory',
    'DISPID_SPEEngineConfidence', 'DISPID_SGRSTsItem',
    'ISpeechLexicon', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SPCPhoneToId', 'DISPID_SVSLastBookmark', 'SBOPause',
    'DISPID_SDKDeleteKey', 'eLEXTYPE_APP', 'SAFT12kHz16BitMono',
    'SPEI_MAX_TTS', 'SpCompressedLexicon',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SABIBufferSize', 'SAFT8kHz16BitMono', 'DISPID_SPEsCount',
    'DISPID_SPELexicalForm', 'SAFTADPCM_22kHzStereo',
    'SPINTERFERENCE_NOSIGNAL', 'SAFTGSM610_11kHzMono', 'SPEI_VISEME',
    'tagSTATSTG', 'SPEI_VOICE_CHANGE', 'SPEI_RESERVED3', 'SDTRule',
    'ISpeechGrammarRuleStateTransitions', 'ISpRecoContext',
    'DISPID_SRSAudioStatus', 'DISPID_SpeechPhraseReplacement',
    'SPFM_CREATE', 'SVP_21', 'SpeechTokenKeyAttributes',
    'SPINTERFERENCE', 'DISPID_SRRGetXMLErrorInfo', 'SP_VISEME_10',
    ...
    'SPRS_ACTIVE', 'SPPS_Verb', 'SpSharedRecoContext',
    'SAFT8kHz16BitStereo', 'SpeechVisemeType',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SpeechAudioBufferInfo',
    'SpeechTokenIdUserLexicon', 'SRAExport', 'SPWORDLIST',
    'DISPID_SBSWrite', 'SPSHORTCUTPAIR', 'SGSExclusive',
    'DISPID_SGRSTWeight', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SPRuleConfidence', 'SPSMF_UPS',
    'DISPID_SDKSetStringValue', 'SASPause', 'SPEI_END_SR_STREAM',
    'SPAUDIOBUFFERINFO', 'eLEXTYPE_PRIVATE4', 'DISPID_SGRSTNextState',
    'SRARoot', 'SPSTREAMFORMATTYPE',
    'DISPID_SpeechLexiconPronunciation', 'SPWT_DISPLAY',
    'DISPID_SpeechObjectTokens', 'Speech_StreamPos_Asap',
    'SDTProperty', 'DISPID_SpeechRecoResult', 'SpeechTokenValueCLSID',
    'DISPID_SPPBRestorePhraseFromMemory', 'SpeechCategoryAudioIn',
    'SINoise', 'SpeechRecognitionType', 'SpeechRuleState',
    'SPEI_UNDEFINED', 'SVP_8', 'DISPID_SRCESoundEnd', 'SFTInput',
    'SPVPRI_OVER', 'DISPID_SRGCmdLoadFromFile', 'DISPID_SBSSeek',
    'DISPID_SPAStartElementInResult', 'SPEI_HYPOTHESIS',
    'ISpObjectToken', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SPEI_MAX_SR', 'SpPhoneConverter', 'DISPID_SVEBookmark',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpAudio', 'SpFileStream',
    'DISPID_SpeechVoiceEvent',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVP_12',
    'DISPID_SGRName', 'DISPIDSPTSI_ActiveLength',
    'SpeechDictationTopicSpelling', 'DISPID_SPACommit',
    'ISpeechMemoryStream', 'SPEI_TTS_BOOKMARK',
    'DISPID_SPEAudioStreamOffset', 'ISpEventSource',
    'SPFM_OPEN_READWRITE', 'SSTTWildcard', 'DISPID_SpeechAudioFormat',
    'SP_VISEME_18', 'SpeechTokenContext', 'ISpRecoGrammar',
    'SPPS_NotOverriden', 'DISPID_SWFEBitsPerSample',
    ...
    'DISPID_SRCState', 'STSF_CommonAppData',
    'DISPID_SDKSetBinaryValue', 'DISPID_SGRSTPropertyId',
    'SAFT16kHz16BitMono', 'DISPID_SGRsAdd', 'SPVPRIORITY',
    'DISPID_SpeechGrammarRules', 'SVP_1', 'DISPID_SLWLangId',
    'SPWORDPRONUNCIATION', 'DISPID_SABufferNotifySize',
    'eLEXTYPE_PRIVATE14', 'SAFTDefault', 'SRTSMLTimeout',
    'SPPS_Function', 'SPWT_LEXICAL', 'SPDKL_LocalMachine',
    'SpeechPropertyComplexResponseSpeed', 'SRCS_Disabled',
    'SpCustomStream', 'DISPID_SGRInitialState', 'SDTAlternates',
    'SRAONone', 'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SMSSetData',
    'DISPID_SPPId', 'DISPID_SDKSetLongValue',
    'DISPID_SRCVoicePurgeEvent', 'SPRST_NUM_STATES',
    'ISpeechRecoResult', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SRGId', 'DISPID_SRProfile', 'DISPID_SPCLangId',
    'DISPID_SGRSAddWordTransition', 'SPDKL_DefaultLocation', 'SVP_10',
    'SAFTGSM610_8kHzMono', 'SpNotifyTranslator', 'DISPID_SVRate',
    'ISpProperties', 'SpeechAddRemoveWord',
    'DISPID_SDKGetStringValue', 'DISPID_SVGetVoices',
    'SpInProcRecoContext', 'SPAUDIOSTATUS', 'SRERecognition',
    'DISPID_SPEPronunciation', 'SSSPTRelativeToEnd', 'ISpEventSink',
    'SpeechLexiconType', 'SAFT11kHz8BitMono', 'SAFT22kHz8BitStereo',
    'SPEI_RESERVED1', 'SPAR_Low', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SASetState', 'SGRSTTDictation', 'DISPID_SLWType',
    'DISPID_SAStatus', 'DISPID_SGRSTs_NewEnum', 'SpeechTokenKeyUI',
    'SpLexicon', 'DISPID_SPIAudioSizeTime', 'SAFT32kHz16BitStereo',
    'ISpVoice', 'ISpeechRecoContext', 'SDTAudio', 'SDKLCurrentConfig',
    'SPPHRASERULE', 'SpeechRuleAttributes',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpeechLexiconPronunciation',
    'SP_VISEME_4', 'DISPID_SPPs_NewEnum', 'SREHypothesis',
    'SPPROPERTYINFO', 'DISPID_SpeechPhoneConverter', 'SPSFunction',
    'ISpRecoCategory', 'SVP_3', 'ISpeechVoiceStatus', 'SRERequestUI',
    'SAFT44kHz16BitMono', 'SAFTCCITT_ALaw_44kHzMono',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SVStatus',
    'DISPID_SPRs_NewEnum', 'DISPID_SRGCommit', 'DISPID_SPPsCount',
    'ISpeechRecognizerStatus', 'SSSPTRelativeToCurrentPosition',
    'IEnumString', 'SPWF_INPUT', 'SPSModifier', '_ISpeechVoiceEvents',
    'ISpPhraseAlt', 'STCInprocHandler', 'ISpRecoContext2',
    'SPRECORESULTTIMES', 'DISPID_SVSyncronousSpeakTimeout',
    'SPRECOSTATE', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SVSInputSentenceLength',
    'DISPID_SRSCurrentStreamPosition', 'SAFTADPCM_44kHzMono',
    'SECFNoSpecialChars', 'DISPID_SRGDictationUnload',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SPEActualConfidence',
    'eLEXTYPE_PRIVATE3', 'SPPS_LMA', 'SPINTERFERENCE_NOISE',
    'SREPrivate', 'SGRSTTRule', 'SAFT32kHz8BitMono',
    'DISPID_SLPPartOfSpeech', 'SPPHRASEELEMENT', 'SP_VISEME_2',
    'SECFIgnoreWidth', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'ISpRecognizer2', 'DISPID_SPRuleNumberOfElements',
    'ISpPhoneticAlphabetSelection', 'DISPID_SLGetPronunciations',
    'SVSFVoiceMask', 'SpeechGrammarWordType',
    'SpeechEngineProperties', 'DISPID_SRIsUISupported',
    'DISPID_SRCCreateResultFromMemory', 'eLEXTYPE_PRIVATE7',
    'SDTLexicalForm', 'SPEI_SR_AUDIO_LEVEL', 'SP_VISEME_1',
    'DISPID_SAVolume', 'SPEI_REQUEST_UI', 'DISPID_SGRsDynamic',
    'DISPID_SRAudioInputStream', 'DISPID_SPRulesCount',
    'SAFT16kHz8BitMono', 'DISPID_SRCResume',
    'ISpeechPhraseReplacements', 'eLEXTYPE_RESERVED6', 'SLTApp',
    'DISPID_SpeechDataKey', 'SPAS_RUN', 'DISPID_SVGetAudioInputs',
    'DISPID_SVEEnginePrivate', 'ISpNotifySink', 'SREStateChange',
    'STCLocalServer', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SPRText',
    'SPINTERFERENCE_TOOSLOW', 'SVP_9', 'SPPS_RESERVED2',
    'SpUnCompressedLexicon', 'SDA_Two_Trailing_Spaces',
    'SpPhraseInfoBuilder', 'SPPS_Noun', 'SPXMLRESULTOPTIONS',
    'ISpeechAudioFormat', 'SPFILEMODE', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SPAs_NewEnum', 'DISPID_SLPPhoneIds',
    'DISPID_SRRSaveToMemory', 'DISPID_SRSetPropertyString',
    'SINoSignal', 'ISpNotifyTranslator', 'SP_VISEME_14',
    'DISPID_SRGCmdSetRuleIdState',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SOTCSetId',
    'DISPID_SVSLastResult', 'SREStreamStart', 'SpeechAudioState',
    'DISPID_SPIRule', 'DISPID_SRCEEnginePrivate',
    ...
    'SAFT24kHz16BitStereo', 'SVP_16', 'SPRST_INACTIVE', 'SVP_13',
    'SpeechBookmarkOptions', 'SpeechGrammarTagDictation',
    'SREAdaptation', 'DISPID_SpeechPhraseInfo', 'SpeechUserTraining',
    'SITooSlow', 'SPEI_START_SR_STREAM', 'DISPID_SRCreateRecoContext',
    'ISpResourceManager', 'SRSActive', 'SRTExtendableParse',
    'SpObjectToken', 'DISPID_SVGetAudioOutputs',
    ...
    'SPDKL_CurrentConfig', 'SDKLLocalMachine', 'SpMMAudioOut',
    'DISPID_SVSkip', 'SpInprocRecognizer', 'SPAR_High',
    'DISPID_SVAlertBoundary', 'DISPID_SRCEAdaptation', 'SRTReSent',
    'SPRS_INACTIVE', 'SpeechGrammarTagWildcard', 'DISPID_SOTId',
    'ISpeechPhraseProperty', 'SPEI_START_INPUT_STREAM',
    'eLEXTYPE_PRIVATE16', 'SVSFDefault', 'DISPID_SLPs_NewEnum',
    'SSTTTextBuffer', 'SPWAVEFORMATTYPE', 'eLEXTYPE_PRIVATE15',
    ...
    'DISPID_SVResume', 'DISPID_SpeechAudio', 'SP_VISEME_3',
    'DISPID_SRGCmdLoadFromObject', 'SPLOADOPTIONS', 'SASStop',
    'DISPID_SPRDisplayAttributes', 'SPPHRASE', 'SRERecoOtherContext',
    'DISPID_SVEAudioLevel', 'SAFTNoAssignedFormat', 'SP_VISEME_13',
    'DISPID_SpeechMemoryStream', 'DISPID_SPIEnginePrivateData',
    'DISPID_SOTs_NewEnum', 'DISPID_SRCERecognition',
    'DISPID_SGRSTransitions', 'SPINTERFERENCE_LATENCY_WARNING',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRGRules',
    'DISPID_SRRSetTextFeedback', 'SpeechDisplayAttributes',
    ...
    'DISPID_SpeechBaseStream', 'DISPID_SPAsCount', 'SITooQuiet',
    'SpeechAudioFormatGUIDText', 'DISPID_SVSVisemeId', 'SGDisplay',
    'SWPUnknownWordPronounceable', 'SRADynamic',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVEVoiceChange',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SOTDisplayUI',
    'SPFM_CREATE_ALWAYS', 'SPADAPTATIONRELEVANCE', 'DISPID_SGRClear',
    'SpeechSpecialTransitionType', 'SpShortcut',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SOTGetStorageFileName', 'SPPARTOFSPEECH', 'SVP_4',
    'SPAO_NONE', 'DISPID_SPPsItem', 'SPSMF_SAPI_PROPERTIES',
    'SpNullPhoneConverter', 'SAFT11kHz16BitStereo',
    'SGLexicalNoSpecialChars', 'DISPID_SPEsItem', 'SINone',
    'DISPID_SpeechPhraseRule', 'DISPID_SpeechLexiconWord',
    'DISPID_SPCIdToPhone', 'ISpObjectWithToken', 'SPXRO_SML',
    'SPVOICESTATUS', 'DISPID_SRGRecoContext', 'DISPID_SRRAlternates',
    'SVF_Stressed', 'SPBO_AHEAD', 'SVSFIsXML',
    'DISPID_SPERetainedStreamOffset', 'SAFTADPCM_44kHzStereo',
    'SP_VISEME_11', 'SREInterference', 'DISPID_SOTCId',
    'DISPID_SVSRunningState', 'DISPID_SRRPhraseInfo',
    'Speech_Max_Pron_Length', 'ISpNotifySource', 'SPGS_EXCLUSIVE',
    'ISpStreamFormat', 'SECFEmulateResult', 'DISPID_SLWs_NewEnum',
    'eLEXTYPE_RESERVED4', 'STCRemoteServer', 'DISPID_SOTSetId',
    'SPCS_ENABLED', 'DISPID_SASCurrentSeekPosition',
    'SAFTGSM610_22kHzMono', 'DISPID_SLGetWords', 'SRSEDone',
    'ISpeechGrammarRules', 'ISpeechAudio', 'SVEVoiceChange',
    'SVSFParseSsml', 'eLEXTYPE_PRIVATE19', 'SP_VISEME_21',
    'SPEI_FALSE_RECOGNITION', 'SPSSuppressWord', 'ISpeechRecoGrammar',
    'SAFT22kHz8BitMono', 'DISPID_SPEDisplayText', 'SAFT24kHz8BitMono',
    'DISPID_SPRuleFirstElement', 'DISPID_SVEPhoneme',
    'SAFT11kHz8BitStereo', 'eWORDTYPE_ADDED', 'SRADefaultToActive',
    'SGDSInactive', 'DISPID_SPEAudioSizeBytes', 'SPEI_TTS_PRIVATE',
    'SPEI_SR_RETAINEDAUDIO', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SVSPhonemeId', 'ISpShortcut', 'SAFT8kHz8BitStereo',
    'SPSEMANTICERRORINFO', 'SLTUser', 'SWPKnownWordPronounceable',
    'DISPID_SpeechGrammarRule', 'DISPID_SABIEventBias',
    'DISPID_SLRemovePronunciation', 'SpeechRecoEvents',
    'SAFT24kHz16BitMono', 'SPBINARYGRAMMAR', 'SVF_Emphasis',
    'DISPID_SDKGetBinaryValue', 'DISPID_SRRAudio',
    'DISPID_SVIsUISupported', 'SVP_7', 'SPPS_Interjection',
    'SGDSActiveWithAutoPause', 'DISPID_SPILanguageId',
    'DISPID_SPEAudioSizeTime', 'ISpeechPhraseElements', 'SP_VISEME_7',
    'SVP_20', 'DISPID_SLPLangId', 'eLEXTYPE_USER', 'SpVoice',
    'SPEI_SENTENCE_BOUNDARY', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SGRs_NewEnum',
    'SPAO_RETAIN_AUDIO', 'SVEPhoneme', 'SPLO_DYNAMIC',
    'DISPID_SPRuleParent', 'SpMMAudioIn', 'DISPID_SASState',
    'SRAImport', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SMSALineId', 'DISPID_SRSetPropertyNumber', 'SVPAlert',
    'SpeechGrammarState', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SRCRetainedAudio', 'SpeechRunState', 'SASRun',
    'SP_VISEME_19', 'SVSFlagsAsync', 'SAFT22kHz16BitMono',
    'DISPID_SVPause', 'SPGS_DISABLED', 'DISPID_SRCEHypothesis',
    'SPEI_PHONEME', 'DISPID_SVEStreamEnd', 'DISPID_SRRecognizer',
    'SpeechPropertyAdaptationOn', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SOTGetAttribute', 'SPPS_RESERVED1',
    'DISPID_SGRsCommitAndSave', 'DISPID_SGRSAddRuleTransition',
    'ISpPhrase', 'DISPID_SPARecoResult',
    'SpeechPropertyResponseSpeed', 'eLEXTYPE_PRIVATE13',
    'Speech_Default_Weight', 'SDTPronunciation', 'SVSFUnusedFlags',
    'SECNormalConfidence', 'DISPID_SPPFirstElement',
    'DISPID_SLWsCount', 'DISPID_SPIGrammarId', 'SPEI_SR_PRIVATE',
    'DISPID_SpeechPhraseElement', 'SVEBookmark', 'SREPhraseStart',
    'eLEXTYPE_RESERVED10', 'SITooFast', 'SAFTCCITT_uLaw_8kHzStereo',
    'SVP_19', 'SPEVENTSOURCEINFO', 'DISPID_SRGState',
    'SAFTGSM610_44kHzMono', 'DISPID_SGRsFindRule',
    'DISPID_SVDisplayUI', 'DISPID_SDKGetlongValue', 'SRATopLevel',
    'SPEI_END_INPUT_STREAM', 'SPEVENTENUM', 'SAFT11kHz16BitMono',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SWFEExtraData',
    'DISPID_SOTDataKey', 'SPGRAMMARWORDTYPE', 'SPCONTEXTSTATE',
    'ISpeechMMSysAudio', 'SPFM_OPEN_READONLY', 'DISPID_SRCPause',
    'DISPID_SRAudioInput', 'DISPID_SVSInputWordPosition',
    'eLEXTYPE_LETTERTOSOUND', 'SPEI_SOUND_END', 'DISPID_SPIStartTime',
    'DISPID_SREmulateRecognition', 'SpeechAudioVolume',
    'DISPID_SVVolume', 'DISPID_SDKDeleteValue',
    'DISPID_SGRSTPropertyValue', 'SGLexical',
    'DISPID_SpeechRecoResultTimes', 'SP_VISEME_5', 'SRSInactive',
    'STCInprocServer', 'SPBO_TIME_UNITS', 'SP_VISEME_12',
    'DISPID_SRState', 'ISpRecoGrammar2', 'SPEI_WORD_BOUNDARY',
    'DISPID_SLPType', 'DISPID_SPPChildren',
    'SPEI_PROPERTY_STRING_CHANGE', 'SP_VISEME_0',
    'DISPID_SRGetRecognizers', 'SP_VISEME_8',
    'DISPID_SOTMatchesAttributes', 'SPCT_SUB_DICTATION',
    'SPRULESTATE', 'SVP_6', 'SPAR_Medium', 'DISPID_SRCEBookmark',
    'SPWT_PRONUNCIATION', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SASClosed', 'ISpeechPhoneConverter', 'DISPID_SpeechRecognizer',
    'DISPID_SRGCmdLoadFromResource', 'SPAS_CLOSED', 'ISpeechDataKey',
    'SVP_11', 'SPVPRI_ALERT', 'SAFTCCITT_uLaw_22kHzMono',
    'SAFT48kHz16BitMono', 'SPEI_RESERVED2', 'SVP_18',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpeechGrammarRule',
    'DISPID_SRRTStreamTime'
]

_check_version('1.2.0', 1698676426.284007)
